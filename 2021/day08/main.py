...
if __name__ == "__main__":
    ...
    for x in data:
        ...
        if args.debug:
            print(s)
    print(
        f"Part 1: the number of 1s, 4s, 7s, and 8s is {number_of_digits[1]}, {number_of_digits[4]}, {number_of_digits[7]}, {number_of_digits[8]} respectively ({number_of_digits[1] + number_of_digits[4] + number_of_digits[7] + number_of_digits[8]} in total)"
    )
